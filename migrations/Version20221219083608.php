 ...
 */
final class Version20221219083608 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE intervenant (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, specialiteprofessionnelle VARCHAR(255) DEFAULT NULL, prenom VARCHAR(70) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
